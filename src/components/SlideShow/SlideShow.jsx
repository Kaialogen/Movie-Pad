...
export default function SlideShow() {
  ...
  return (
    <>
      <div className='max-w-[1800px] relative m-auto mt-[80px]'>
        {slides.map((slide, index) => (
          <div key={index} className={`mySlides fade`} style={{ display: index === slideIndex ? 'block' : 'none' }}>
            ...
            <div className='absolute top-[40px] left-[20px] max-w-[600px] bg-slate-900 bg-opacity-50 p-4 rounded-2xl pl-5 pr-5 ml-5'>
              <h4 className='text-white text-2xl text-center font-inter'>Welcome to Moviepad!</h4>
