function adventure(){
    ...
    document.getElementById('shrek').style.display = "inline";
    document.getElementById('bee-movie').style.display = "inline";
}
...
function scienceFiction(){
    ...
    document.getElementById('bee-movie').style.display = "none";
}
